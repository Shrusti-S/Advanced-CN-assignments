...
int sendFile(FILE *fp, int newSock)
{
    ...
    cout << "Requested file is sent to client: " << newSock << endl;
    fclose(fp);
    return 1;
}
...
int main()
{
    ...
    // structure for connecting to bootstrap server
    ...
    // create socket for TCP connection to communicate with clients
